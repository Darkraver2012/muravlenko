document.addEventListener("DOMContentLoaded", function() {	
	...
	document.getElementsByName("quarter_select")[0].addEventListener("change", function() {
		quarter=this.value;
		showAttendance(quarter);
	});

	function showAttendance(quarter = 1) {
		...
		xmlhttp.open("GET", "ajax/get_attendance.php?quarter="+quarter, true);
		xmlhttp.send();
	}
